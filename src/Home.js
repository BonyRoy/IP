...
<div className="col-md-4 col-10 mx-auto">
  ...
  <div class="card-body">
  <p class="card-title">
  Our applications are User Friendly</p>
...
<div className="col-md-4 col-10 mx-auto">
  ...
  <div class="card-body">
  <p class="card-title">
  We are into Excellence Services</p>
    <a href="#" class="btn btn-outline-primary">&#62; </a>
  </div>
</div>
</div>
...
>Some Features of NP Infoserve Technologies</h5>
<br></br>
<br></br>
<br></br>
<br></br>
...
<h2
           ...
           <h6
            ...
            >Innovation:- Innovation here in NP Infoserve refers to A change in a product offering, service, business model,Software and web Development, ERP , HRMS and CRM applications or operations which meaningfully improves the experience of a large number of clients.We refer innovation as a changes in accordance to IT Solutions.</h6>
            <br></br>
            <h6
                  style={{
                    color: '#2b1785',
            ...
            >Commitment:- commitment as an important component of successful market relationships, it gives rise to co-operative behaviours & industry standards. With us relationship is characterised by co-operation between two parties is more likely to be long-term, participative and focused on achieving qualitative software services .</h6>
            <br></br>
            <h6
                  style={{
                    color: '#2b1785',
            ...
            >Mission:- To provide technology services to Small, Medium and Enterprise customers Provides end-to-end IT solutions, support, development,implementation,staffing and deployment services</h6>
            <div className="mt-3">
</div>
